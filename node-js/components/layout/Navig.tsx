  ...
  return (
    <div className={style.navig}>
      <div id={style.navigBtns}>
        <UBNavig uid={new CUID('navig.buttons.main')} props={{iconSrc:'/icons/info.png',iconAlt:"Main"}} language={props.language} />
        <UBNavig uid={new CUID('navig.buttons.projects')} props={{iconSrc:'/icons/portfolio.png',iconAlt:"Projects",prefetch:true}} language={props.language} />
        <UBNavig uid={new CUID('navig.buttons.feedback')} props={{iconSrc:'/icons/comment.png',iconAlt:"Comment"}} language={props.language} />
        <UBNavig uid={new CUID('navig.buttons.contact')} props={{iconSrc:'/icons/contacts.png',iconAlt:"Contacts",prefetch:true}} language={props.language} />
